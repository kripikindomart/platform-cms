...
describe('MenusService', () => {
  ...
  describe('findAll', () => {
    it('harus mengembalikan array menuses', async () => {
      ...
      mockMenusRepository.findAll.mockResolvedValue(mockData);
    ...
    it('harus mengembalikan array kosong jika tidak ada data', async () => {
      mockMenusRepository.findAll.mockResolvedValue([]);
  ...
  describe('findById', () => {
    it('harus mengembalikan menu berdasarkan ID', async () => {
      ...
      mockMenusRepository.findById.mockResolvedValue(mockData);
    ...
    it('harus throw NotFoundException jika tidak ditemukan', async () => {
      mockMenusRepository.findById.mockResolvedValue(null);
  ...
  describe('create', () => {
    it('harus membuat menu baru', async () => {
      ...
      mockMenusRepository.create.mockResolvedValue(mockCreated);
  ...
  describe('update', () => {
    it('harus mengupdate menu yang ada', async () => {
      ...
      mockMenusRepository.findById.mockResolvedValue({ id: 1 });
      mockMenusRepository.update.mockResolvedValue(mockUpdated);
  ...
  describe('delete', () => {
    it('harus soft delete menu', async () => {
      mockMenusRepository.findById.mockResolvedValue({ id: 1 });
      mockMenusRepository.softDelete.mockResolvedValue(undefined);
  ...
  describe('findAllWithQuery', () => {
    it('harus mengembalikan data dengan pagination', async () => {
      ...
      mockMenusRepository.findAllWithQuery.mockResolvedValue(mockResult);
