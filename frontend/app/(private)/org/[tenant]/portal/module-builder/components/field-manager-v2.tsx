...
export function FieldManager({ fields, setFields }: FieldManagerProps) {
  ...
  const handleUpdateField = (index: number, updates: Partial<ModuleField>) => {
    ...
    // UUID fields are auto-generated by the database (see gen_random_uuid()
    // default added to the generated migration/schema) - never user input.
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-neutral-50/50 border-b border-neutral-200">
                  ...
                  <th className="px-4 py-3 text-center text-xs font-semibold text-neutral-700 w-20">Visible</th>
                  <th className="px-4 py-3 text-center text-xs font-semibold text-neutral-700 w-20">Required</th>
