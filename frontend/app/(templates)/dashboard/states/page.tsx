...
import { ArrowLeft, AlertCircle, Inbox, Loader2, Server, Construction, CheckCircle2, XCircle } from 'lucide-react';
  ...
  const states = [
    {
      id: 'empty',
      title: 'Empty State',
      description: 'No data or content available',
      icon: Inbox,
      color: 'from-indigo-500 to-purple-600',
      href: '/dashboard/states/empty',
      status: 'ready',
    },
    {
      id: 'loading',
      title: 'Loading State',
      description: 'Data fetching and loading indicators',
      icon: Loader2,
      color: 'from-cyan-500 to-blue-600',
      href: '/dashboard/states/loading',
      status: 'ready',
    },
    {
      id: 'error-404',
      ...
      href: '/dashboard/states/error-404',
      status: 'ready',
    },
    {
      id: 'error-500',
      ...
      href: '/dashboard/states/error-500',
      status: 'ready',
    },
    {
      id: 'maintenance',
      ...
      href: '/dashboard/states/maintenance',
      status: 'ready',
    },
    {
      id: 'success',
      ...
      <header className="border-b border-neutral-200 bg-white/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-bold text-neutral-900">State Pages</h1>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-lg text-neutral-600 max-w-2xl">
            Production-ready state pages for empty states, loading, errors, maintenance,
            and success messages. All with premium animations and helpful actions.
          </p>
        </motion.div>
              ...
              >
                {isReady ? (
                  <Link href={state.href}>
                    <div className="group h-full p-6 bg-white rounded-2xl border border-neutral-200 hover:border-indigo-200 hover:shadow-xl transition-all cursor-pointer">
                      <div className="flex items-start justify-between mb-4">
                        <div
                          className={`w-12 h-12 rounded-xl bg-gradient-to-br ${state.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform`}
                        >
                  ...
                  <div className="h-full p-6 bg-white rounded-2xl border border-neutral-200">
                    <div className="flex items-start justify-between mb-4">
                      <div
                        className={`w-12 h-12 rounded-xl bg-gradient-to-br ${state.color} flex items-center justify-center shadow-lg opacity-50`}
                      >
                        <Icon className="w-6 h-6 text-white" />
                      </div>
