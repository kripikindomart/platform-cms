...
import { ArrowLeft, Table, Users, Package, FileText, Settings, BarChart3 } from 'lucide-react';
  ...
  const tables = [
    {
      id: 'users',
      title: 'Users Table',
      description: 'User management with actions',
      icon: Users,
    ...
    },
    {
      ...
      description: 'Product catalog with images',
      icon: Package,
      color: 'from-cyan-500 to-blue-600',
      href: '/dashboard/tables/products',
      status: 'ready',
    },
    {
      id: 'orders',
      title: 'Orders Table',
      description: 'Order history with status',
      icon: FileText,
      color: 'from-green-500 to-emerald-600',
      href: '/dashboard/tables/orders',
      status: 'ready',
    },
    {
      id: 'analytics',
      title: 'Analytics Table',
      description: 'Data analytics with charts',
      icon: BarChart3,
      color: 'from-amber-500 to-orange-600',
      href: '/dashboard/tables/analytics',
      status: 'ready',
    },
  ];
      ...
      <header className="border-b border-neutral-200 bg-white/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-bold text-neutral-900">Table Templates</h1>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-lg text-neutral-600 max-w-2xl">
            Advanced data tables with sorting, filtering, search, pagination,
            and actions. Optimized for performance and usability.
          </p>
        </motion.div>
              ...
              >
                {isReady ? (
                  <Link href={table.href}>
                    <div className="group h-full p-6 bg-white rounded-2xl border border-neutral-200 hover:border-indigo-200 hover:shadow-xl transition-all cursor-pointer">
                      <div className="flex items-start justify-between mb-4">
                        <div
                          className={`w-12 h-12 rounded-xl bg-gradient-to-br ${table.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform`}
                        >
                  ...
                  <div className="h-full p-6 bg-white rounded-2xl border border-neutral-200">
                    <div className="flex items-start justify-between mb-4">
                      <div
                        className={`w-12 h-12 rounded-xl bg-gradient-to-br ${table.color} flex items-center justify-center shadow-lg opacity-50`}
                      >
                        <Icon className="w-6 h-6 text-white" />
                      </div>
