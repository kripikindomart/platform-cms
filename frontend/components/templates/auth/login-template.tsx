...
import { ArrowRight, Sparkles, Shield, Zap, Hexagon, Eye, EyeOff } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          >
            ...
            <p className="text-xl text-white/80 mb-12 leading-relaxed max-w-md">
              The modern platform trusted by teams at the world's leading companies.
            </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  disabled={isLoading}
                  required
                  className="h-12 rounded-xl border-neutral-200 bg-white focus:border-indigo-500 focus:ring-indigo-500/20 transition-all pr-12"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-4 h-4 rounded border-neutral-300 text-indigo-600 focus:ring-indigo-500/20"
              />
              ...
              <>
                <div className="relative py-4">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-[#FAFBFC] text-neutral-500 font-medium">
                      Or continue with
                    </span>
                  </div>
                </div>
